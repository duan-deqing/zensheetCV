...
const STATIC_CHANGELOG: ChangelogEntry[] = [
  {
    ...
    tag: '免登录版',
    items: [
      '新增「请作者喝杯咖啡」入口：微信 / 支付宝收款码一键切换，支持后释放礼花并展示感谢卡片',
      '操作提示统一为屏幕顶部中央胶囊样式，反馈更聚焦',
      '全部弹窗与侧栏统一关闭动画：模板库、图标库、照片、设置、文档抽屉、主题面板与 AI 助手',
      '保存按钮状态切换过渡动画：文案淡入、成功落定回弹，自动保存同样生效',
      '全屏预览打开淡入动画，与编辑视图过渡衔接',
      '默认用户名改为 ZENSHEET，支持在设置中自定义用户名',
    ],
  },
  {
    version: 'v0.1.0',
