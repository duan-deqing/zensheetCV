...
export function IconModal() {
  ...
  return (
    ...
    >
      ...
      <div className={`${closing ? 'modal-out' : 'icon-modal-in'} relative flex flex-col bg-white border border-gray-200 rounded-2xl shadow-xl overflow-hidden w-full h-[calc(100dvh_-_1rem)] sm:h-auto sm:w-[min(760px,100%)] sm:max-h-[78vh]`}>
